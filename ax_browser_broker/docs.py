...
TOPICS: dict[str, dict[str, Any]] = {
    ...
    "routing": {
        ...
        "rules": [
            ...
            "takeover_request rejects auth-sensitive current tabs with HTTP 409 and tells the caller to use auth_request.",
    ...
    "auth": {
        ...
        "steps": [
            ...
            "takeover_request and lease_control_request refuse login/password/passkey/2FA/provider pages and return HTTP 409 with auth_request guidance.",
